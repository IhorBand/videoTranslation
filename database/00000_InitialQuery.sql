...
CREATE TABLE [dbo].[File](
	...
	[FileServerId] UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [dbo].[FileServer](Id),
	[FileTypeId] TINYINT NOT NULL FOREIGN KEY REFERENCES [dbo].[L_FileType](Id),
	[Size] BIGINT NULL,
...
CREATE TABLE [dbo].[VideoFile](
	[Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_VideoFile DEFAULT NEWSEQUENTIALID() PRIMARY KEY,
	[VideoInfoId] UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [dbo].[VideoInfo](Id),
	[FileId] UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [dbo].[File](Id),
	[VideoTypeId] TINYINT NOT NULL FOREIGN KEY REFERENCES [dbo].[L_VideoType](Id),
